      ...
      <div className="card">
        ...
        <div className="card-content">
          {[
            ...
            <div key={c.cls} className="list-row">
              <div>
...
const ParentDashboard = () => (
  <>
    ...
    <div className="card">
      ...
      <div className="card-content">
        {[
          { subject: "Mathematics", score: 45, risk: "HIGH" as const },
          { subject: "English", score: 72, risk: "LOW" as const },
          { subject: "Physics", score: 52, risk: "MEDIUM" as const },
          { subject: "Chemistry", score: 68, risk: "LOW" as const },
        ].map((s) => (
          <div key={s.subject} className="list-row">
            <div>
