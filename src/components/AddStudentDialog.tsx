...
interface StudentFormData {
  admissionNo: string; fullName: string; className: string; stream: string; dateOfBirth: string;
  parentFullName: string; parentIdNumber: string; parentPhone: string; parentEmail: string; parentRelationship: string;
}
...
const AddStudentDialog = () => {
  ...
  return (
    <>
      ...
      {open && (
        <div className="modal-backdrop" role="dialog" aria-modal="true" onClick={(e) => e.target === e.currentTarget && setOpen(false)}>
          <div className="modal">
