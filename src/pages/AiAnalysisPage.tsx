...
const MOCK_ANALYSIS = [
  { student: "Brian Otieno", admissionNo: "ADM2024001", subject: "Mathematics", riskPercentage: 82, riskLevel: "HIGH" as const,
  ...
  { student: "Faith Wambui", admissionNo: "ADM2024002", subject: "Physics", riskPercentage: 74, riskLevel: "HIGH" as const,
  ...
  { student: "Dennis Njoroge", admissionNo: "ADM2024003", subject: "Chemistry", riskPercentage: 55, riskLevel: "MEDIUM" as const,
...
const riskClass = { HIGH: "danger", MEDIUM: "warning", LOW: "success" } as const;
...
const AiAnalysisPage = () => (
  <div className="animate-fade-in">
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
      {MOCK_ANALYSIS.map((a) => (
        <div key={a.admissionNo + a.subject} className="card">
          <div className="card-content">
            <div className="ai-card-row">
              <div className="flex-1">
                <div className="flex items-center gap-3 mb-2">
                  <h3 style={{ fontSize: "1rem" }}>{a.student}</h3>
                  <span className="text-xs font-mono muted-text">{a.admissionNo}</span>
                  <span className={`badge ${riskClass[a.riskLevel]}`}>{a.riskLevel}</span>
                </div>
                <p className="text-sm muted-text mb-3">Subject: {a.subject}</p>
